...
namespace GM
{
	...
	enum ESceneRoleReviveResult
	{
		...
		SCENE_ROLE_REVIVE_RESULT_REACH_MAX_TIMES,		  //已到达复活最大数
	};
	...
	enum EChallengeArenaRoleResult
	{
		ECHALLENGE_ARENA_ROLE_RESULT_SUCCESS,
		ECHALLENGE_ARENA_ROLE_RESULT_FAIL,
	};

	enum EChallengeArenaRoleFinishResult
	{
		ECHALLENGE_ARENA_ROLE_FINISH_RESULT_SUCCESS,
		ECHALLENGE_ARENA_ROLE_FINISH_RESULT_FAIL,
		ECHALLENGE_ARENA_ROLE_FINISH_RESULT_NOT_IN_ARENA,
		ECHALLENGE_ARENA_ROLE_FINISH_RESULT_NOT_CHALLENGE_ANY_ROLE_YET,
		ECHALLENGE_ARENA_ROLE_FINISH_RESULT_CHALLENGEE_NOT_EXIST,
	};

	enum EGetInstanceDataResult
	{
		EGET_INSTANCE_DATA_RESULT_SUCCESS = 0,
		EGET_INSTANCE_DATA_RESULT_FAIL,
	};

	enum ESendStageResultReportResult
	{
		...
		ESEND_STAGE_RESULT_REPORT_HAS_REPROT_RESULT,

	};

	enum EClearStageResult
	{
	...
	enum EGetInstanceStarPrizeResult
	{
	...
	enum EGetContinuousInstanceDataResult
	{
	...
	enum EReportContinuousStageResultResult
	{
	...
	enum EResetContinuousInstanceResult
	{
	...
	enum EDetermineStagePrizeItemResult
	{
	...
	enum EPurchaseArenaTicketsResult
	{
		EPURCHASE_ARENA_TICKETS_SUCCESS = 0,
		EPURCHASE_ARENA_TICKETS_FAIL,
		EPURCHASE_ARENA_DAILY_LIMITED,
		EPURCHASE_ARENA_NOT_ENOUGH_DIAMOND,
	};

	enum ERestoreStageTicketsResult
	{
