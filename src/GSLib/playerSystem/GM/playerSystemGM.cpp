...
bool CPlayerSystemGM::_loadGameConfig(const std::string& a_configPath)
{
...
bool CPlayerSystemGM::_initServerMsg(BSLib::Framework::CMsgExecMgr* a_msgExecMgr)
{
...
void CPlayerSystemGM::_cbServerEnter(const GFLib::SServerID& a_serverID, const std::string& a_key)
{
	GSLib::DBSystem::CDBCommonSystem::_cbServerEnter(a_serverID, a_key);
}

void CPlayerSystemGM::_cbServerLeave(const GFLib::SServerID& a_serverID, const std::string& a_key)
{
