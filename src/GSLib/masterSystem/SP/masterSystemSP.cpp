...
bool CMasterSystemSP::ICommonSystem_loadGameConfig(const std::string& a_configPath)
{	
...
bool CMasterSystemSP::ICommonSystem_initServerMsg(BSLib::Framework::CMsgExecMgr* a_msgExecMgr)
{	
...
void CMasterSystemSP::ICommonSystem_cbServerLeave(const GFLib::SServerID& a_serverID, const std::string& a_key)
{	
	if(a_serverID.m_type == GSLib::SRVTYPE_CENTERSERVER)
	{	
