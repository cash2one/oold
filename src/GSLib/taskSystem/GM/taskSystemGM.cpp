...
bool CTaskSystemGM::_loadGameConfig(const std::string& a_configPath)
{
...
bool CTaskSystemGM::_initServerMsg(BSLib::Framework::CMsgExecMgr* a_msgExecMgr)
{
...
void CTaskSystemGM::_cbServerEnter(const GFLib::SServerID& a_serverID, const std::string& a_key)
{
	GSLib::DBSystem::CDBCommonSystem::_cbServerEnter(a_serverID, a_key);
}

void CTaskSystemGM::_cbServerLeave(const GFLib::SServerID& a_serverID, const std::string& a_key)
{
