...
bool CActivitySystemGM::ICommonSystem_loadGameConfig(const std::string& a_configPath)
{
...
bool CActivitySystemGM::ICommonSystem_initServerMsg(BSLib::Framework::CMsgExecMgr* a_msgExecMgr)
{	
...
void CActivitySystemGM::ICommonSystem_cbServerLeave(const GFLib::SServerID& a_serverID, const std::string& a_key)
{
