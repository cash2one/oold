//////////////////////////////////////////////////////////////////////
//	created:	2012/10/21
//	filename:	src\BSLib\behaviorTree\btWeightSelectorNode.h
//	author:		mazhejiang
//	
///	purpose:	
//////////////////////////////////////////////////////////////////////
#ifndef __BSLIB_BEHAVIORTREE_BTWEIGHTSELECTORNODE_H__
#define __BSLIB_BEHAVIORTREE_BTWEIGHTSELECTORNODE_H__
 ...
 */
class CBTWeightSelectorNode : public CBTNode
{

public:
	//!Constructor initializes member variables. Receives the parent of this new node.
	CBTWeightSelectorNode(CBTNode *a_parent);
...
#endif//__BSLIB_BEHAVIORTREE_BTWEIGHTSELECTORNODE_H__
