...
void CSuperStub::_finalStub()
{
	;
}

void CSuperStub::_initStubMsg(BSLib::Framework::CMsgExecMgr* msgExecMgr)
{
...
// 	
// 	BSLIB_LOG_INFOR(Server::ETT_SERVER_COMMON, "请求登陆[AccountName=%s][Zone=%d][Channel=%d]"
...
// 
// 	BSLIB_LOG_INFOR(Server::ETT_SERVER_COMMON, "请求注册[AccountName=%s][Zone=%d][Channel=%d]"
// 		, reqAccountLogin->m_accountName.c_str()
// 		, reqAccountLogin->m_zoneID
// 		, reqAccountLogin->m_channelID);
// 
