...
# 连接库
DEBUG_LIBS=dbSystem_debug loginSystem_debug commonServer_debug network_debug udm_debug database_debug framework_debug utility_debug pthread rt mysqlclient uuid
RELEASE_LIBS=dbSystem_release loginSystem_release commonServer_release network_release udm_release database_release framework_release utility_release pthread rt mysqlclient uuid
