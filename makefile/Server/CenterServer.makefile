...
# 连接库
DEBUG_LIBS=masterSystem_debug sceneSystem_debug skillSystem_debug rankSystem_debug friendSystem_debug mailSystem_debug chatSystem_debug playerSystem_debug dbSystem_debug loginSystem_debug commonServer_debug network_debug udm_debug database_debug framework_debug utility_debug pthread rt mysqlclient uuid
RELEASE_LIBS=masterSystem_release sceneSystem_release skillSystem_release rankSystem_release friendSystem_release mailSystem_release chatSystem_release playerSystem_release dbSystem_release loginSystem_release commonServer_release network_release udm_release database_release framework_release utility_release pthread rt mysqlclient uuid
